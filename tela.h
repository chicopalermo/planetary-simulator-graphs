...
// retorna a posi??o x do mouse
float tela_rato_x(void);

// retorna a posi??o y do mouse
...
// retorna a posi??o x do mouse na ?ltima vez que ele foi clicado
float tela_rato_x_clique(void);

// retorna a posi??o y do mouse na ?ltima vez que ele foi clicado
